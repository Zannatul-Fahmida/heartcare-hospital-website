        ...
        <Navbar collapseOnSelect expand="lg" className="bg-light">
            <Container>
                ...
                <Navbar.Collapse className="justify-content-end">
                    ...
                    <Nav.Link as={Link} to="/faqs" className="text-dark text-center">FAQs</Nav.Link>
                    {user.email ?
                        <div className="d-flex flex-md-row flex-column align-items-center">
                            <span className="pe-0 pe-md-3 text-center pb-2 pb-md-0 fw-bold">{user.displayName}</span>
